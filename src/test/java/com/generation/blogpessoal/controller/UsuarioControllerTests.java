...
public class UsuarioControllerTests {
	...
	@DisplayName("Login")
	public void Login () {
		usuarioService.cadastrarUsuario(new Usuario(0L,"Gustavo Santos", "gustavo@email.com.br", "12345678910", "https://i.imgur.com/5M2p5Wb.jpg"));
		HttpEntity<UsuarioLogin> resposta = new HttpEntity<UsuarioLogin>(new UsuarioLogin("gustavo@email.com.br","12345678910"));

		ResponseEntity<UsuarioLogin> bodyResposta  = testRestTemplate
				.withBasicAuth("root", "root") // autenticar o usuário para retornar.
				.exchange("/usuarios/logar", HttpMethod.POST, resposta, UsuarioLogin.class);
		
		assertEquals(HttpStatus.OK, bodyResposta.getStatusCode());
